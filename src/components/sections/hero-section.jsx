      ...
      <div className="container mx-auto px-6 max-w-[1300px] relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 text-left max-w-2xl pt-10">
          ...
          >
            ...
            <button className="w-full sm:w-auto bg-transparent border-2 border-[#E91E63]/20 hover:border-[#E91E63]/40 hover:bg-[#FFF0F5] text-[#2D2D2D] px-8 py-4 rounded-full font-bold transition-all duration-300">
