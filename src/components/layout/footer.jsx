    ...
    <footer className="bg-[#1A0A10] pt-32 pb-8 rounded-t-[3rem] -mt-10 relative z-10 flex flex-col items-center overflow-hidden">
      ...
      >
        <button onClick={() => window.location.href = "https://play.google.com/store/apps/details?id=com.woosh.in"} className="bg-white hover:bg-[#FFF0F5] text-[#2D2D2D] px-8 py-4 rounded-full flex items-center gap-3 transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_25px_rgba(233,30,99,0.15)]">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-[#E91E63]">
            <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.61 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
          </svg>
          <div className="text-left">
            <div className="text-[10px] font-bold uppercase tracking-wider text-[#757575] leading-none mb-1">Download the</div>
            <div className="text-xl font-bold leading-none tracking-tight">Passenger App</div>
          </div>
        </button>
        <button onClick={() => window.location.href = "https://play.google.com/store/apps/details?id=com.woosh.ride"} className="bg-white hover:bg-[#FFF0F5] text-[#2D2D2D] px-8 py-4 rounded-full flex items-center gap-3 transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_25px_rgba(233,30,99,0.15)]">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-[#E91E63]">
            <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.61 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
          </svg>
          <div className="text-left">
            <div className="text-[10px] font-bold uppercase tracking-wider text-[#757575] leading-none mb-1">Download the</div>
            <div className="text-xl font-bold leading-none tracking-tight">Rider App</div>
          </div>
        </button>
      </motion.div>
